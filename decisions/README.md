...
| ID | 문서 | 핵심 결정 |
|---|---|---|
| **TD-01** | [결제↔예약 도메인의 순환 의존을 어떻게 풀었나](./td-01-payment-reservation-dependency-boundary.md) | 새 구조를 추가하기보다 기존 Port/Adapter 경계를 재사용 |
| **TD-02** | [예약 운영 정책과 인증 무효화 설계](./td-02-reservation-auth-operational-decisions.md) | 노쇼·취소·스케줄러·Blacklist 5개 의사결정 |

## 관리 기준

- `TD`는 도메인·정책·구현 단위의 기술적 의사결정입니다.
